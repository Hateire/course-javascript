...
const value = returnFirstArgument("Osmanthus wine tastes the same as I remember... But where are those who shared the memories?")
...
const result = sumWithDefaults(1000, 337);
